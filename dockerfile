...
#copy dependencies from requirements.txt file
COPY requirements.txt .

#Install python dependencies (add curl if you use MLFLOW local tracking URI)
RUN pip install --upgrade pip \ 
    && pip install -r requirements.txt \
    && apt-get clean && rm -rf /var/lib/apt/lists/*
    
#Copy teh entire project into the image
COPY . . 
...
COPY src/serving/model/c101e5e120b745d5bfcfeca57e636398/artifacts/model /app/model
#COPY src/serving/model/c101e5e120b745d5bfcfeca57e636398/artifacts/feature_columns.txt /app/model/feature_columns.txt
COPY src/serving/model/c101e5e120b745d5bfcfeca57e636398/artifacts/preprocessing.pkl /app/model/preprocessing.pkl
